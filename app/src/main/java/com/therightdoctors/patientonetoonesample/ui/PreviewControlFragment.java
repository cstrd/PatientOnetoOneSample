...
import com.therightdoctors.patientonetoonesample.MainActivity;
import com.therightdoctors.patientonetoonesample.R;
    ...
    public void updateCall() {
       ...
       mActivity.getWrapper().addSignalListener("Started", this);
        if(mActivity.isCallInProgress()){
            ...
            mActivity.getWrapper().getSession().sendSignal("Started","Connected");
        }else{
